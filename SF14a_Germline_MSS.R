...
if (variable == 'age_eo') {
    title = 'Age of onset enrichment of P/LP germline variants in MSS cases (n=75/802)'
    subtitle = 'Adjusted by sex, country, and tumor subsite'
}
...
write.csv(testdata_to_st, '../supplementary_tables_regressions/SNT29.csv', quote=F, row.names=F)
