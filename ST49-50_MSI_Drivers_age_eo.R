...
testdata_to_st = testdata %>%
    ...
    rename(#Country = country,
           ...
           'q-value' = q_val_2,
           'Model' = model_used)
write.csv(testdata_to_st, '../supplementary_tables_regressions/SNT18.csv', quote=F, row.names=F)
...
write.csv(testdata_to_st, '../supplementary_tables_regressions/SNT19.csv', quote=F, row.names=F)
