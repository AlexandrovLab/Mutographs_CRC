...
testdata_to_st = testdata %>%
    ...
    rename(Country = country,
           ...
           'q-value' = q_val_2,
           'Model' = model_used)
write.csv(testdata_to_st, '../supplementary_tables_regressions/SNT21.csv', quote=F, row.names=F)
...
testdata_to_st = testdata %>%
    ...
    rename(Country = country,
           ...
           'q-value' = q_val_2,
           'Model' = model_used)
write.csv(testdata_to_st, '../supplementary_tables_regressions/SNT22.csv', quote=F, row.names=F)
