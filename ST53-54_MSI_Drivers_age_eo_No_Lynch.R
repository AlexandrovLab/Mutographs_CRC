...
testdata_to_st = testdata %>%
    ...
    rename(#Country = country,
           ...
           'q-value' = q_val_2,
           'Model' = model_used)
write.csv(testdata_to_st, '../supplementary_tables_regressions/SNT24.csv', quote=F, row.names=F)
...
write.csv(testdata_to_st, '../supplementary_tables_regressions/SNT25.csv', quote=F, row.names=F)
